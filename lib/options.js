...
module.exports = optionator({
  ...
  options: [
    ...
    },
    {
      ...
      type: 'Boolean',
      default: false,
      description: 'Output execution environment information (required the ESLint@6.5.0 or later)'
    },
    {
      option: 'error-on-unmatched-pattern',
      type: 'Boolean',
      default: true,
      description: 'Prevent errors when pattern is unmatched (required the ESLint@6.8.0 or later)'
    },
    {
      option: 'debug',
      type: 'Boolean',
